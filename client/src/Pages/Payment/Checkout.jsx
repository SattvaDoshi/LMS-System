            ...
            >
                <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                    ...
                    <div className="px-4 space-y-5 text-center">
                        <p className="text-[17px] dark:text-white text-black">
                        This purchase will allow you to access all the available courses on our platform for {" "}

                        <span className="font-bold text-yellow-700 dark:text-yellow-500">1 yr duratrion</span>{" "}
                        ...
                        <div className="dark:text-gray-200 text-black">
