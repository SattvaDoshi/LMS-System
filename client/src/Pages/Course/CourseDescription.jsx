            ...
            <div className="space-y-4">
              <div className="flex flex-col text-lg font-inter">
                <p className="font-semibold">
                  <span className="text-yellow-600 text-2xl dark:text-yellow-500 font-bold">
                    Total lectures : {" "}
                  </span>
                  <span className="text-2xl">{state?.numberOfLectures}</span>
                </p>
                ...
                <p className="font-semibold">
                  ...
                  <span className="text-2xl">{state?.createdBy}</span>
                </p>
              </div>
            </div>
          </div>
