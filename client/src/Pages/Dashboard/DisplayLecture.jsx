          ...
          <div className="flex md:flex-row flex-col md:justify-between w-full h-full">
            ...
            <div className="md:w-[48%] pb-12 md:flex-row flex-col w-full md:h-full h-[60%] overflow-y-scroll">
              <ul className="w-full md:p-2 p-0  flex flex-col gap-5 shadow-sm">
                ...
                <li className="font-semibold md:bg-slate-50 dark:bg-slate-100 p-3 rounded-md shadow-lg sticky top-0 text-xl text-[#2320f7] font-nunito-sans flex items-center justify-between">
                  <p>Lectures list</p>
                  { role === "ADMIN" && (
                    <button
                      onClick={() =>
                ...
                {lectures &&
                  lectures.map((lecture, idx) => {
                    return (
                      <li className="space-y-2 pl-4 pt-2" key={lecture._id}>
                        <p
