    ...
    return (
      <div className="drawer absolute left-0 z-50 w-fit">
        ...
        <div className="drawer-side w-0 shadow-custom dark:shadow-lg">
          ...
          ></label>
          <ul className="menu px-6 pt-7 h-[100%] min-w-[250px] max-w-[550px] bg-white dark:bg-[#29303ea3] backdrop-blur-[8px] text-gray-500 font-inter dark:text-slate-50 md:text-[17px] text-base font-[600] relative">
            <li className="w-fit absolute right-0 z-50 text-red-500">
